...
public class ConcurrentHashMap<K, V> extends AbstractMap<K, V>
    ...
    public ConcurrentHashMap(int initialCapacity,
        ...
        // 示例：concurrencyLevel 默认 16
        // concurrencyLevel = 8 , ssize = 8 , sshift = 3
        // concurrencyLevel = 15 , ssize = 16 , sshift = 4
        // concurrencyLevel = 16 , ssize = 16 , sshift = 4
    ...
    public V put(K key, V value) {
        ...
        //    然后和 segmentMask(15) 做一次与操作，也就是说 j 是 hash 值的高 4 位（最大15），也就是槽的数组下标
